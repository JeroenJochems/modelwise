...
import {NewDashboardViewModel} from "@/types/generated";
...
type Props = { vm: NewDashboardViewModel } & PageProps

export default function NewDashboard(props: Props) {
                                ...
                                <div className={"w-2/3 grid gap-4 p-4 my-4 flex-grow"}>
                                    ...
                                    <div className={"flex"}>
                                        <CtaLink
                                            ...
                                            href={route("new-roles.show", listing.role.id)}/>
                                    </div>
                                </div>
