...
use EventSauce\EventSourcing\TestUtilities\EventStager;
use EventSauce\EventSourcing\TestUtilities\ExpectedEvent;
...
abstract class AggregateTestCase extends TestCase
{
    ...
    public function handle(\Closure $arguments)
    {
